...
def build_limited_index_data_points(
    ...
    async def limited(data_points, vector_engine=None):
        ...
        is_targeted = isinstance(embedding_engine, targeted_embedding_engine_class)
        if is_targeted:
            ...
            if bypass_key not in _logged_embedding_bypasses:
                ...
                logger.info(
                    ...
                    "provider=%s; COGNEE_EMBEDDING_BATCH_CONCURRENCY applies "
                    "only to the configured native embedding engine",
...
def install_cognee_pipeline_concurrency(
    ...
    *,
    ...
    if embedding_engine_class is None:
        ...
        embedding_engine_class = embedding_module.OllamaEmbeddingEngine
