...
const faqs = [
  {
    question: "Nuomi Drama Factory 和普通 AI 视频生成工具有什么区别？",
    answer:
      "普通工具通常围绕一次提示词、一个片段或一张图工作。Nuomi Drama Factory 面向的是完整项目：从剧本导入、资产沉淀、剧集规划、镜头制作到合成导出，形成可追踪、可协作、可复用的生产闭环。",
  },
  {
    question: "第一次使用应该从哪里开始？",
    answer:
      "建议先走主线工作流：在剧本导入建立文本，到资产中心确认角色、场景、道具和声线，在剧集制作依次完成剧本校对、导演拆解与镜头设计，最后进入成片合成导出。第一次目标不是做完美，而是先跑通一集。",
  },
  {
    question: "剧集制作和创作画布分别适合做什么？",
    answer:
      "剧集制作是主生产线，适合批量、稳定、按剧集推进；创作画布适合关键镜头精修、多版本探索、资产定稿和复杂视频处理。正式项目通常在剧集制作推进普通镜头，让复杂镜头进入创作画布。",
  },
  {
    question: "创作画布里的结果会自动覆盖主线资产吗？",
    answer:
      "不会。创作画布里的生成或上传内容默认是候选结果。只有明确点击写回，并选择角色、场景、道具、Beat 草图、首帧或视频等目标槽位后，结果才会进入正式项目主线。",
  },
  {
    question: "为什么要先整理角色、场景、道具和声线？",
    answer:
      "AI 视频创作最容易返工的原因，往往不是最后一步视频生成，而是前面的角色不稳定、场景不清楚、道具缺参考、声线没统一。资产中心先把这些内容变成可复用资产，可以显著减少后续镜头阶段的混乱。",
  },
  {
    question: "Nuomi Drama Factory 适合哪些内容类型？",
    answer:
  ...
  {
    question: "Nuomi Drama Factory 如何保持系列内容一致？",
    answer:
      "Nuomi Drama Factory 通过项目资产持续复用角色、世界观、场景与视觉风格，让每一集沿用已经确认的创作基准。",
  },
  {
    question: "登录后我会进入哪里？",
    answer:
