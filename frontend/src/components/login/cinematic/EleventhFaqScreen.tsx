...
const faqs = [
  {
    question: "NuomiDrama 和普通 AI 视频生成工具有什么区别？",
    answer:
      "普通工具通常围绕一次提示词、一个片段或一张图工作。NuomiDrama 面向的是完整项目：从剧本导入、资产沉淀、剧集规划、镜头制作到合成导出，形成可追踪、可协作、可复用的生产闭环。",
  },
  {
  ...
  {
    question: "NuomiDrama 如何保持系列内容一致？",
    answer:
      "NuomiDrama 通过项目资产持续复用角色、世界观、场景与视觉风格，让每一集沿用已经确认的创作基准。",
  },
  {
    question: "登录后我会进入哪里？",
    answer:
