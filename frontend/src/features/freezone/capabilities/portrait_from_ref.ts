...
export const portraitFromRefCapability: GenerationCapability = {
  ...
  compose({ inputUrls, params, nodePrompt }) {
    ...
    const prompt = `Create a production-ready character identity portrait candidate for ${character}.
...
- Use a clean, readable contact-sheet layout suitable for production character assets.
